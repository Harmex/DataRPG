...
#scoreboard players set @s dmd_stn 0
#scoreboard players set @s dmd_dsl 0
#scoreboard players set @s gld_stn 0
#scoreboard players set @s gld_ntr 0
#scoreboard players set @s gld_dsl 0
#scoreboard players set @s lps_ntr 0
#scoreboard players set @s lps_dsl 0
#scoreboard players set @s irn_stn 0
#scoreboard players set @s irn_dsl 0
#scoreboard players set @s col_stn 0
#scoreboard players set @s col_dsl 0
#scoreboard players set @s qtz_stn 0
