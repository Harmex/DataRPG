scoreboard players set Difficulty Difficulty 666
...
tellraw @s [{"text":"Nightmare : ","bold":true},{"text":"[V]","bold":true,"color":"green","hoverEvent":{"action":"show_text","contents":["Current Difficulty"]}}]
tellraw @s [{"text": ""}]
tellraw @s [{"text": ""}]
tellraw @s [{"text": ""}]
tellraw @s [{"text": ""}]
